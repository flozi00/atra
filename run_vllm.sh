...
# 1. create base string for the command
cmd="python3 -m vllm.entrypoints.openai.api_server --use-v2-block-manager --enforce-eager --ngram-prompt-lookup-max 5 --enable-lora --max-loras 4 --max-lora-rank 64"
