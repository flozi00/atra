...
class DatastoreBatch:
    def __init__(
        self, dim, batch_size, flat_index=False, gpu_index=False, verbose=False
    ) -> None:
        self.indices = []
        ...
        for i in range(batch_size):
            self.indices.append(
                Datastore(
                    dim, use_flat_index=flat_index, gpu_index=gpu_index, verbose=verbose
                )
            )
...
class Datastore:
    def __init__(
        self, dim, use_flat_index=False, gpu_index=False, verbose=False
    ) -> None:
        self.dimension = dim
