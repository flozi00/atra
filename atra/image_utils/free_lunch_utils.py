# from https://huggingface.co/spaces/ChenyangSi/FreeU/blob/main/app.py
import torch
        ...
        def forward(
            ...
            for resnet in self.resnets:
                ...
                if hidden_states.shape[1] == 1280:
                    ...
                    hidden_states[:, :640] = hidden_states[:, :640] * (
                        (self.b1 - 1) * hidden_mean + 1
                    )
                ...
                if hidden_states.shape[1] == 640:
                    ...
                    hidden_states[:, :320] = hidden_states[:, :320] * (
                        (self.b2 - 1) * hidden_mean + 1
                    )
                    res_hidden_states = Fourier_filter(
